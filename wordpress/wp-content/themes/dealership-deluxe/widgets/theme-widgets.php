      ...
      <li class="new-arrivals-list"> <a class="arrivals-link" href="<?php the_permalink();?>">
        ...
        <div class="arrivals-details">   
        	<p class="vehicle-name"><?php the_title(); ?></p>
				...
				<?php if (is_numeric( $fields['blackbookprice'])){ 
					echo $symbols['currency'].number_format($fields['blackbookprice']).'</span><br/>'; 
				} else  {'</span>'; } ?>
				<?php if (is_numeric( $fields['price'])){ ?>Our Price: <?php } ?><span class="price"><?php if (is_numeric( $fields['price'])){ echo $symbols['currency'].number_format($fields['price']).'</span>'; } else  { echo '<span class="price">'.$fields['price'].'</span>' ; } ?><br/>
