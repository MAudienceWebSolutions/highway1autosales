...
"blackbookprice" => array(
	  "name" => "blackbookprice", 
  	  "title" => $options['blackbookprice_text'],//'Black Book Price',//$options['blackbookprice_text'],
	  "description" => "Enter the full vehicle black book price without commas or dots.",
	  "type" => "range",
	  "class" => "range",
	  "rows" => "",
          "width" => "",
	  "hide_in_search" => $options['blackbookpricehide'],//'Yes',//$options['blackbookpricehide'],
	  "options" => ""
		), 
 "statustag" => array(
	  "name" => "statustag", 
